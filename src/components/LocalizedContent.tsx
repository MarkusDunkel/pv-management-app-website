...
export default function LocalizedContent() {
  ...
  const demoHref = buildDemoLink(import.meta.env.DEV ? 'https://localhost:5173': 'https://app.homewatts.xyz', demoAccessKey);

  console.log('demoHref: ', demoHref)
        ...
        <div className="gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              { demoAccessKey  &&<div>{'demo-access-key: ' + demoAccessKey }</div>}
            </div>
          </div>
        </div>
      </SectionHeading>
